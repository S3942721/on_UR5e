    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'par_utils.action.GripperSetWidth_Goal')
            logger.debug(
...
class Metaclass_GripperSetWidth_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'par_utils.action.GripperSetWidth_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_GripperSetWidth_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'par_utils.action.GripperSetWidth_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class GripperSetWidth_SendGoal_Request(metaclass=Metaclass_GripperSetWidth_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'par_utils/GripperSetWidth_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['par_utils', 'action'], 'GripperSetWidth_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from par_utils.action._gripper_set_width import GripperSetWidth_Goal
...
class Metaclass_GripperSetWidth_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'par_utils.action.GripperSetWidth_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from par_utils.action import _gripper_set_width
...
class GripperSetWidth_SendGoal(metaclass=Metaclass_GripperSetWidth_SendGoal):
    from par_utils.action._gripper_set_width import GripperSetWidth_SendGoal_Request as Request
    from par_utils.action._gripper_set_width import GripperSetWidth_SendGoal_Response as Response
...
class GripperSetWidth_GetResult_Response(metaclass=Metaclass_GripperSetWidth_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'par_utils/GripperSetWidth_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['par_utils', 'action'], 'GripperSetWidth_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from par_utils.action._gripper_set_width import GripperSetWidth_Result
...
class Metaclass_GripperSetWidth_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'par_utils.action.GripperSetWidth_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class GripperSetWidth_GetResult(metaclass=Metaclass_GripperSetWidth_GetResult):
    from par_utils.action._gripper_set_width import GripperSetWidth_GetResult_Request as Request
    from par_utils.action._gripper_set_width import GripperSetWidth_GetResult_Response as Response
...
class Metaclass_GripperSetWidth_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'par_utils.action.GripperSetWidth_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class GripperSetWidth_FeedbackMessage(metaclass=Metaclass_GripperSetWidth_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'par_utils/GripperSetWidth_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['par_utils', 'action'], 'GripperSetWidth_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from par_utils.action._gripper_set_width import GripperSetWidth_Feedback
...
class Metaclass_GripperSetWidth(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'par_utils.action.GripperSetWidth')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class GripperSetWidth(metaclass=Metaclass_GripperSetWidth):
    ...
    from par_utils.action._gripper_set_width import GripperSetWidth_Goal as Goal
    # The result message defined in the action definition.
    from par_utils.action._gripper_set_width import GripperSetWidth_Result as Result
    # The feedback message defined in the action definition.
    from par_utils.action._gripper_set_width import GripperSetWidth_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from par_utils.action._gripper_set_width import GripperSetWidth_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from par_utils.action._gripper_set_width import GripperSetWidth_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from par_utils.action._gripper_set_width import GripperSetWidth_FeedbackMessage as FeedbackMessage

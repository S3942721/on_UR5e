...
static PyMethodDef par_utils__methods[] = {
  {NULL, NULL, 0, NULL}  /* sentinel */
};

static struct PyModuleDef par_utils__module = {
...
PyMODINIT_FUNC
PyInit_par_utils_s__rosidl_typesupport_fastrtps_c(void)
{
  PyObject * pymodule = NULL;
  pymodule = PyModule_Create(&par_utils__module);
  if (!pymodule) {
    return NULL;
  }
  int8_t err;
